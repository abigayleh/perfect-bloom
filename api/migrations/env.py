...
def render_item(type_, obj, autogen_context) -> str | bool:
    """Render UtcDateTime as the plain SQL type.

    A migration must never import app code — this class could be renamed or
    deleted, and migrations have to keep running years later. The DDL is
